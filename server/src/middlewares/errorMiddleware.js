...
const handleDuplicateFieldsDB = err => {
    // Regex to find the value in quotes if needed, but Sequelize usually gives a message
...
module.exports = (err, req, res, next) => {
    console.log(err.stack); // Always log stack trace in console for debugging
